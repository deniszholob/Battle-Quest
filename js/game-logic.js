...
export class GameLogic {
    ...
    static getNewEntity(characterData) {
        return {
    ...
    static fight(actionChar) {
        const actionEnemy = this.getEnemyAction(this.enemy);
    ...
    static showNextEnemy(defeatedEnemy) {
    ...
    static setCharacterStats(stats) {
